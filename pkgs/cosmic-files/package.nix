...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
     owner = "pop-os";
     repo = "cosmic-files";
     rev = "62ba16c4011d77a6e66788db7760b9f4ba7ce14d";
     hash = "sha256-kEF8oj3yHlSk05roQsu2v/gASF2f1w/ok1XkJJ6RPh0=";
  };

  cargoHash = "sha256-jsocCMe2ZtWzeLPisg3tK1HxUh4GSqz63cHIUx+j748="; 
